...
function benchmark_irreducible!(suite::BenchmarkGroup)
    ...
    vs_dumbbell = [
        ...
        (c(Bulk(3)), bar(q)(Bulk(4))),  # Bridge: edge 3-4
        (c(Bulk(4)), bar(q)(Bulk(5))),  # Triangle 2: edge 4-5
        (c(Bulk(5)), bar(q)(Bulk(6))),  # Triangle 2: edge 5-6
        (c(Bulk(6)), bar(q)(Bulk(4))),   # Triangle 2: edge 6-4
    ]
    ...
    vs_k4 = [
        ...
        (c(Bulk(2)), bar(q)(Bulk(3))),  # Edge 2-3
        (c(Bulk(2)), bar(q)(Bulk(4))),  # Edge 2-4
        (c(Bulk(3)), bar(q)(Bulk(4))),   # Edge 3-4
    ]
    ...
    vs_square_diag = [
        ...
        (c(Bulk(4)), bar(q)(Bulk(1))),  # Square: edge 4-1
        (c(Bulk(1)), bar(q)(Bulk(3))),   # Diagonal: edge 1-3
    ]
    ...
    vs_k5 = [
        ...
        (c(Bulk(1)), bar(q)(Bulk(3))),  # Edge 1-3
        (c(Bulk(1)), bar(q)(Bulk(4))),  # Edge 1-4
        (c(Bulk(1)), bar(q)(Bulk(5))),  # Edge 1-5
        (c(Bulk(2)), bar(q)(Bulk(3))),  # Edge 2-3
        (c(Bulk(2)), bar(q)(Bulk(4))),  # Edge 2-4
        (c(Bulk(2)), bar(q)(Bulk(5))),  # Edge 2-5
        (c(Bulk(3)), bar(q)(Bulk(4))),  # Edge 3-4
        (c(Bulk(3)), bar(q)(Bulk(5))),  # Edge 3-5
        (c(Bulk(4)), bar(q)(Bulk(5))),   # Edge 4-5
    ]
    ...
    vs_tree = [
        ...
        (c(Bulk(2)), bar(q)(Bulk(5))),  # Left subtree
        (c(Bulk(3)), bar(q)(Bulk(6))),  # Right subtree
        (c(Bulk(3)), bar(q)(Bulk(7))),   # Right subtree
    ]
